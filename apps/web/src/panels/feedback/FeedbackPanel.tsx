...
export function FeedbackPanel() {
  ...
  const submit = async () => {
    ...
    // `sending` drives the button's disabled state and its "submitting" label,
    // but nothing ever set it — the state was unreachable.
    setSending(true);
    try {
    ...
    return (
      <div style={{ padding: 20 }}>
        <div className="card" style={{ textAlign: 'center', padding: 24 }}>
          ...
          <button className="btn btn-brand btn-sm" style={{ marginTop: 14 }} onClick={() => setSent(false)}>
            {t('btn.submitNewFeedback', lang)}
          </button>
        </div>
      </div>
    );
  ...
  return (
    ...
    >
      <div className="card">
        <div style={{ padding: '10px 14px', borderBottom: '1px solid var(--edge)', fontSize: 13, fontWeight: 700 }}>
        ...
        <div style={{ padding: 14 }}>
          ...
          <div className="form-grp">
            ...
            <textarea
              ...
              style={{ minHeight: 100 }}
              placeholder={t('feedback.bodyPlaceholder', lang)}
              value={body}
          ...
          <div className="form-grp">
            ...
            <input
              className="form-input"
              placeholder={t('feedback.contactPlaceholder', lang)}
              value={email}
