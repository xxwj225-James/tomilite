...
export function LoadingScreen() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: 'var(--bg)', flexDirection: 'column', fontFamily: 'sans-serif' }}>
      <svg width="60" height="60" viewBox="0 0 20 20" style={{ fill: 'var(--brand)', animation: 'pulse 2s ease-in-out infinite' }}>
      ...
      <div style={{ width: 200, height: 3, background: 'var(--surface2)', borderRadius: 2, marginTop: 12, overflow: 'hidden' }}>
        <div style={{ width: '30%', height: '100%', background: 'linear-gradient(90deg, var(--brand), var(--brand-hover))', borderRadius: 2, animation: 'barSlide 1.5s ease-in-out infinite' }} />
      </div>
