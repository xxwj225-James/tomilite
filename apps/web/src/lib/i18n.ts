...
const I18N = {
  // ═══ Chat Area ═══
  'chat.placeholder': { en: 'Ask me anything...', zh: '随时问我...', ja: '何でも聞いてください...', th: 'ถามอะไรก็ได้...', mi: 'Pātai mai...', ru: 'Спросите что угодно...' },
  'chat.thinking': { en: 'Thinking...', zh: '思考中...', ja: '考え中...', th: 'กำลังคิด...', mi: 'E whakaaro ana...', ru: 'Думаю...' },
  'chat.queued': { en: 'Queued...', zh: '已排队...', ja: '待機中...' },
  'chat.working': { en: 'Working...', zh: '工作中...', ja: '作業中...', th: 'กำลังทำงาน...', mi: 'E mahi ana...', ru: 'Работаю...' },
  ...
  'chat.noLLM': { en: '⚠️ LLM API Key not configured. AI chat unavailable.\n\nPlease configure your API Key in Settings → LLM.', zh: '⚠️ 未配置 LLM API Key，AI 聊天功能不可用。\n\n请在 Settings → LLM 中配置 API Key 后再试。', ja: '⚠️ LLM APIキーが未設定です。\n\nSettings → LLM でAPIキーを設定してください。' },
  'chat.sendEnter': { en: 'Send (Enter)', zh: '发送 (Enter)', ja: '送信 (Enter)', th: 'ส่ง (Enter)', mi: 'Tuku (Enter)', ru: 'Отправить (Enter)' },
  'chat.sendToInterrupt': { en: 'Send to interrupt', zh: '发送并中断', ja: '送信して中断', th: 'ส่งเพื่อขัดจังหวะ', mi: 'Tuku hei haukoti', ru: 'Отправить и прервать' },
  'chat.hintEsc': { en: '⏹ Esc to stop  ·  Type to interrupt', zh: '⏹ Esc 停止  ·  输入以中断', ja: '⏹ Escで停止  ·  入力して中断', th: '⏹ Esc เพื่อหยุด  ·  พิมพ์เพื่อขัดจังหวะ', mi: '⏹ Pēhi Esc hei whakamutu', ru: '⏹ Esc для остановки  ·  Ввод для прерывания' },
  'chat.compress': { en: 'Compress', zh: '压缩', ja: '圧縮', th: 'บีบอัด', mi: 'Whakarāpopoto', ru: 'Сжать' },
  'chat.compressing': { en: 'Compressing...', zh: '压缩中...', ja: '圧縮中...', th: 'กำลังบีบอัด...', mi: 'E whakarāpopoto ana...', ru: 'Сжимаю...' },
  'chat.clear': { en: 'Clear', zh: '清除', ja: 'クリア', th: 'ล้าง', mi: 'Whakawātea', ru: 'Очистить' },
  'chat.compressTooltip': { en: 'Compress — summarize conversation', zh: '压缩 — 总结对话', ja: '圧縮 — 会話を要約', th: 'บีบอัด — สรุปการสนทนา', mi: 'Whakarāpopoto — whakarāpopotohia te kōrero', ru: 'Сжать — суммировать разговор' },
  'chat.clearTooltip': { en: 'Clear messages', zh: '清除消息', ja: 'メッセージをクリア', th: 'ล้างข้อความ', mi: 'Whakawātea karere', ru: 'Очистить сообщения' },
  'chat.download': { en: 'Download', zh: '下载', ja: 'ダウンロード', th: 'ดาวน์โหลด', mi: 'Tikiake', ru: 'Скачать' },
  'chat.uploadFile': { en: 'Upload file', zh: '上传文件', ja: 'ファイルをアップロード', th: 'อัปโหลดไฟล์', mi: 'Tukuatu kōnae', ru: 'Загрузить файл' },
  'chat.compressTitle': { en: 'Compress Chat', zh: '压缩对话', ja: 'チャットを圧縮', th: 'บีบอัดแชท', mi: 'Whakarāpopoto Kōrero', ru: 'Сжать чат' },
  'chat.compressMessage': { en: 'Summarize this conversation into 2-3 bullet points? The summary will be sent as a new message to condense the context.', zh: '将本次对话总结为2-3个要点？总结将作为新消息发送以压缩上下文。', ja: 'この会話を2-3の箇条書きに要約しますか？要約が新しいメッセージとして送信され、コンテキストが圧縮されます。', th: 'สรุปการสนทนานี้เป็น 2-3 ข้อ?', mi: 'Whakarāpopotohia tēnei kōrero?', ru: 'Суммировать этот разговор в 2-3 пункта?' },
  'chat.compressTooFew': { en: 'Chat history is too short — need at least 4 messages to compress.', zh: '聊天记录太少，至少需要 4 条消息才能压缩。', ja: 'チャット履歴が短すぎます — 圧縮には少なくとも4つのメッセージが必要です。' },
  ...
  'menu.mcp': { en: 'MCP Approve', zh: 'MCP审批', ja: 'MCP 承認', th: 'ตรวจสอบ MCP', mi: 'Arotake MCP', ru: 'Аудит MCP' },
  ...
  'menu.newChat': { en: '+ New Chat', zh: '+ 新对话', ja: '+ 新規チャット', th: '+ แชทใหม่', mi: '+ Kōrero Hou', ru: '+ Новый чат' },

  // ═══ Pin ═══
  'pin.top': { en: '📌 Pin to top', zh: '📌 置顶', ja: '📌 ピン留め', th: '📌 ปักหมุด', mi: '📌 Titi', ru: '📌 Закрепить' },
  'pin.pinned': { en: '📌 Pinned', zh: '📌 已置顶', ja: '📌 ピン留め中', th: '📌 ปักหมุดแล้ว', mi: '📌 Kua Titi', ru: '📌 Закреплено' },
  ...
  'btn.saving': { en: 'Saving...', zh: '保存中...', ja: '保存中...', th: 'กำลังบันทึก...', mi: 'E tiaki ana...', ru: 'Сохранение...' },
  'btn.saved': { en: '✅ Saved', zh: '✅ 已保存', ja: '✅ 保存済み', th: '✅ บันทึกแล้ว', mi: '✅ Kua Tiaki', ru: '✅ Сохранено' },
  'btn.saveFailed': { en: 'Save failed', zh: '保存失败', ja: '保存失敗', th: 'บันทึกล้มเหลว', mi: 'Tiaki Rāhua', ru: 'Ошибка сохранения' },
  'btn.saveAs': { en: '📥 Save As', zh: '📥 另存为', ja: '📥 名前を付けて保存', th: '📥 บันทึกเป็น', mi: '📥 Tiaki Hei', ru: '📥 Сохранить как' },
  ...
  'btn.exportSelected': { en: 'Export selected', zh: '导出选中笔记', ja: '選択をエクスポート', th: 'ส่งออกที่เลือก', mi: 'Whakaputa', ru: 'Экспорт' },
  'btn.refreshList': { en: 'Refresh list', zh: '刷新列表', ja: 'リスト更新', th: 'รีเฟรชรายการ', mi: 'Whakahou', ru: 'Обновить' },
  'btn.new': { en: '+ New', zh: '+ 新建', ja: '+ 新規', th: '+ ใหม่', mi: '+ Hou', ru: '+ Новый' },
  'btn.create': { en: '+ Create', zh: '+ 新建', ja: '+ 作成', th: '+ สร้าง', mi: '+ Waihanga', ru: '+ Создать' },
  'btn.apply': { en: '✅ Apply', zh: '✅ 应用', ja: '✅ 適用', th: '✅ นำไปใช้', mi: '✅ Whakahono', ru: '✅ Применить' },
  'btn.undo': { en: '↩ Undo', zh: '↩ 撤销', ja: '↩ 元に戻す', th: '↩ ยกเลิก', mi: '↩ Whakakore', ru: '↩ Отменить' },
  'btn.forceCreate': { en: 'Force Create', zh: '强行创建', ja: '強制作成', th: 'บังคับสร้าง', mi: 'Waihanga', ru: 'Принудительно' },
  'btn.restartNow': { en: 'Restart Now', zh: '立即重启', ja: '今すぐ再起動', th: 'รีสตาร์ทตอนนี้', mi: 'Whakaara Ināianei', ru: 'Перезапустить' },
  'btn.leave': { en: 'Leave', zh: '离开', ja: '閉じる', th: 'ออก', mi: 'Wehe', ru: 'Выйти' },
  'btn.send': { en: 'Send', zh: '发送', ja: '送信', th: 'ส่ง', mi: 'Tuku', ru: 'Отправить' },
  'btn.sending': { en: 'Sending...', zh: '发送中...', ja: '送信中...', th: 'กำลังส่ง...', mi: 'E tuku ana...', ru: 'Отправка...' },
  'btn.submit': { en: '📨 Submit', zh: '📨 提交', ja: '📨 送信', th: '📨 ส่ง', mi: '📨 Tuku', ru: '📨 Отправить' },
  'btn.submitting': { en: 'Submitting...', zh: '提交中...', ja: '送信中...', th: 'กำลังส่ง...', mi: 'E tuku ana...', ru: 'Отправка...' },
  'btn.submitNewFeedback': { en: 'Submit New Feedback', zh: '提交新反馈', ja: '新規フィードバック', th: 'ส่งข้อเสนอแนะใหม่', mi: 'Tuku Urupare Hou', ru: 'Новый отзыв' },

  // ═══ Dialog ═══
  'dialog.unsavedChanges': { en: 'Unsaved Changes', zh: '未保存的更改', ja: '保存されていない変更', th: 'การเปลี่ยนแปลงที่ไม่ได้บันทึก', mi: 'Ngā Panoni Kāore i Tiakina', ru: 'Несохранённые изменения' },
  ...
  'staged.preview': { en: 'Preview', zh: '内容预览', ja: 'プレビュー', th: 'ดูตัวอย่าง', mi: 'Arokite', ru: 'Предпросмотр' },
  ...
  // ═══ Home Panel ═══
  'home.taskStats': { en: '📊 Task Statistics', zh: '📊 任务统计', ja: '📊 タスク統計', th: '📊 สถิติงาน', mi: '📊 Tauanga Mahi', ru: '📊 Статистика' },
  ...
  'home.priority': { en: 'Priority', zh: '优先级分布', ja: '優先度分布', th: 'การกระจายลำดับ', mi: 'Tuari', ru: 'Приоритет' },
  'home.completion': { en: 'Completion', zh: '完成度', ja: '達成度', th: 'ความสำเร็จ', mi: 'Whakaoti', ru: 'Завершение' },
  'home.velocity': { en: 'Velocity', zh: '速度', ja: '速度', th: 'ความเร็ว', mi: 'Tere', ru: 'Скорость' },
  'home.git': { en: 'Git', zh: 'Git 活跃', ja: 'Git アクティビティ', th: 'กิจกรรม Git', mi: 'Ngohe Git', ru: 'Активность Git' },
  ...
  'home.trend': { en: '📊 7-Day Trend', zh: '📊 近7天趋势', ja: '📊 7日間の推移', th: '📊 7 วัน', mi: '📊 7 Rā', ru: '📊 7 дн.' },
  'home.healthScore': { en: '❤️ My Health Score', zh: '❤️ 我的健康分', ja: '❤️ ヘルススコア', th: '❤️ คะแนนสุขภาพ', mi: '❤️ Hauora', ru: '❤️ Здоровье' },
  'home.knowledgeMap': { en: '🧠 Knowledge Map', zh: '🧠 知识地图', ja: '🧠 ナレッジマップ', th: '🧠 แผนที่ความรู้', mi: '🧠 Mahere Mātauranga', ru: '🧠 Карта знаний' },
  'home.aiGenerated': { en: '🤖 AI-generated from your tasks and notes', zh: '🤖 AI 根据你的任务和笔记自动提炼生成', ja: '🤖 AIがタスクとノートから自動生成', th: '🤖 AI สร้างจากงานและบันทึก', mi: '🤖 AI i hanga mai i ō mahi me ō tuhipoka', ru: '🤖 AI создано из задач и заметок' },
  'home.loading': { en: 'Loading...', zh: '加载中...', ja: '読み込み中...', th: 'กำลังโหลด...', mi: 'E uta ana...', ru: 'Загрузка...' },

  // ═══ Notes Panel ═══
  'notes.search': { en: '🔍 Search notes...', zh: '🔍 搜索笔记...', ja: '🔍 ノート検索...', th: '🔍 ค้นหาบันทึก...', mi: '🔍 Rapu tuhipoka...', ru: '🔍 Поиск...' },
  ...
  'notes.clickToSort': { en: 'Click to sort', zh: '点击排序', ja: 'クリックでソート', th: 'คลิกเพื่อเรียง', mi: 'Pāwhiria hei kōmaka', ru: 'Нажмите для сортировки' },
  'notes.noteTitle': { en: 'Note title', zh: '笔记标题', ja: 'ノートタイトル', th: 'ชื่อบันทึก', mi: 'Taitara Tuhipoka', ru: 'Заголовок' },
  'notes.placeholder': { en: 'Write your note... (Markdown supported)', zh: '写下你的笔记...（支持 Markdown）', ja: 'ノートを書く...（Markdown対応）', th: 'เขียนบันทึก... (รองรับ Markdown)', mi: 'Tuhia tō tuhipoka...', ru: 'Пишите заметку... (Markdown)' },
  'notes.polish': { en: '✨ Pol', zh: '✨ 润色', ja: '✨ 推敲', th: '✨ ขัดเกลา', mi: '✨ Whakapaipai', ru: '✨ Обработка' },
  'notes.translate': { en: '🌐 Tran', zh: '🌐 翻译', ja: '🌐 翻訳', th: '🌐 แปล', mi: '🌐 Whakamāori', ru: '🌐 Перевод' },
  'notes.summarize': { en: '📝 Sum', zh: '📝 总结', ja: '📝 要約', th: '📝 สรุป', mi: '📝 Whakarāpopoto', ru: '📝 Итог' },
  'notes.expand': { en: '📖 Exp', zh: '📖 扩写', ja: '📖 拡張', th: '📖 ขยาย', mi: '📖 Whakawhānui', ru: '📖 Расширить' },
  'notes.deleteNote': { en: 'Delete Note', zh: '删除笔记', ja: 'ノート削除', th: 'ลบบันทึก', mi: 'Mukua Tuhipoka', ru: 'Удалить заметку' },
  'notes.deleteConfirm': { en: 'Delete this note? This action cannot be undone.', zh: '删除这条笔记？此操作无法撤销。', ja: 'このノートを削除しますか？元に戻せません。', th: 'ลบบันทึกนี้? ไม่สามารถยกเลิกได้', mi: 'Mukua tēnei tuhipoka? Kāore e taea te whakakore.', ru: 'Удалить заметку? Это необратимо.' },
  'notes.saveFailed': { en: 'Save Failed', zh: '保存失败', ja: '保存失敗', th: 'บันทึกล้มเหลว', mi: 'Tiaki Rāhua', ru: 'Ошибка сохранения' },
  'notes.noNotes': { en: 'No notes yet.', zh: '暂无笔记。', ja: 'ノートがありません。', th: 'ยังไม่มีบันทึก', mi: 'Kāore anō he tuhipoka.', ru: 'Нет заметок.' },
  'notes.untitled': { en: 'Untitled', zh: '未命名', ja: '無題', th: 'ไม่มีชื่อ', mi: 'Kore Taitara', ru: 'Без названия' },
  'notes.untitledNote': { en: 'Untitled Note', zh: '无标题笔记', ja: '無題ノート', th: 'บันทึกไม่มีชื่อ', mi: 'Tuhipoka Kore Taitara', ru: 'Заметка без названия' },
  'notes.general': { en: 'General', zh: '通用', ja: '一般', th: 'ทั่วไป', mi: 'Whānui', ru: 'Общее' },
  'notes.architecture': { en: 'Architecture', zh: '架构', ja: 'アーキテクチャ', th: 'สถาปัตยกรรม', mi: 'Hoahoa', ru: 'Архитектура' },
  'notes.apiDocs': { en: 'API Docs', zh: 'API 文档', ja: 'API ドキュメント', th: 'เอกสาร API', mi: 'Tuhinga API', ru: 'API Документы' },
  'notes.runbook': { en: 'Runbook', zh: '操作手册', ja: 'ランブック', th: 'คู่มือ', mi: 'Pukapuka', ru: 'Руководство' },

  // ═══ Tasks Panel ═══
  'tasks.search': { en: '🔍 Search...', zh: '🔍 搜索...', ja: '🔍 検索...', th: '🔍 ค้นหา...', mi: '🔍 Rapu...', ru: '🔍 Поиск...' },
  'tasks.allTypes': { en: 'All Types', zh: '全部类型', ja: '全ての種類', th: 'ทุกประเภท', mi: 'Ngā Momo', ru: 'Все типы' },
  'tasks.allPriority': { en: 'All Priority', zh: '全部优先级', ja: '全ての優先度', th: 'ทุกลำดับ', mi: 'Katoa', ru: 'Все' },
  'tasks.allStatus': { en: 'All Status', zh: '全部状态', ja: '全てのステータス', th: 'ทุกสถานะ', mi: 'Katoa', ru: 'Все' },
  'tasks.type.task': { en: '✅ Task', zh: '✅ 任务', ja: '✅ タスク', th: '✅ งาน', mi: '✅ Mahi', ru: '✅ Задача' },
  'tasks.type.bug': { en: '🐛 Bug', zh: '🐛 缺陷', ja: '🐛 バグ', th: '🐛 บั๊ก', mi: '🐛 Hapa', ru: '🐛 Баг' },
  'tasks.type.story': { en: '📖 Story', zh: '📖 故事', ja: '📖 ストーリー', th: '📖 สตอรี่', mi: '📖 Pūrākau', ru: '📖 История' },
  'tasks.type.email': { en: '📥 Email', zh: '📥 邮件', ja: '📥 メール', th: '📥 อีเมล', mi: '📥 Īmēra', ru: '📥 Почта' },
  'tasks.status.todo': { en: 'Todo', zh: '待办', ja: '未着手', th: 'Todo', mi: 'Todo', ru: 'Todo' },
  'tasks.status.inProgress': { en: 'In Progress', zh: '进行中', ja: '進行中', th: 'กำลังทำ', mi: 'Kei te Haere', ru: 'В процессе' },
  'tasks.status.inReview': { en: 'In Review', zh: '评审中', ja: 'レビュー中', th: 'กำลังตรวจ', mi: 'Kei te Arotake', ru: 'На проверке' },
  ...
  'tasks.priority.medium': { en: '🔵 Medium', zh: '🔵 中', ja: '🔵 中', th: '🔵 กลาง', mi: '🔵 Waenga', ru: '🔵 Средний' },
  ...
  'tasks.description': { en: 'Description', zh: '描述', ja: '説明', th: 'คำอธิบาย', mi: 'Whakaahuatanga', ru: 'Описание' },
  ...
  'tasks.required': { en: ' (required)', zh: '（必填）', ja: '（必須）', th: ' (จำเป็น)', mi: ' (hiahia)', ru: ' (обяз.)' },
  'tasks.descMarkdown': { en: 'Description (Markdown supported)', zh: '描述（支持 Markdown）', ja: '説明（Markdown対応）', th: 'คำอธิบาย (Markdown)', mi: 'Whakaahuatanga (Markdown)', ru: 'Описание (Markdown)' },
  'tasks.newTask': { en: 'New Task', zh: '新任务', ja: '新規タスク', th: 'งานใหม่', mi: 'Mahi Hou', ru: 'Новая задача' },
  'tasks.emailDetail': { en: '📥 Email Task Detail', zh: '📥 邮件任务详情', ja: '📥 メールタスク詳細', th: '📥 รายละเอียดงานอีเมล', mi: '📥 Taipitopito Mahi Īmēra', ru: '📥 Детали задачи' },
  'tasks.from': { en: 'From: ', zh: '发件人：', ja: '送信者：', th: 'จาก：', mi: 'Nā：', ru: 'От：' },
  'tasks.markDone': { en: 'Mark Done', zh: '标记完成', ja: '完了マーク', th: 'ทำเครื่องหมายเสร็จ', mi: 'Tohu Kua Oti', ru: 'Отметить готово' },
  'tasks.markDoneConfirm': { en: 'Mark this email task as done?', zh: '将此邮件任务标记为完成？', ja: 'このメールタスクを完了にしますか？', th: 'ทำเครื่องหมายงานอีเมลนี้ว่าเสร็จ?', mi: 'Tohua tēnei mahi īmēra kua oti?', ru: 'Отметить как готово?' },
  'tasks.deleteConfirm': { en: 'Delete this task? This action cannot be undone.', zh: '删除此任务？此操作无法撤销。', ja: 'このタスクを削除しますか？元に戻せません。', th: 'ลบงานนี้? ไม่สามารถยกเลิกได้', mi: 'Mukua tēnei mahi? Kāore e taea te whakakore.', ru: 'Удалить задачу? Это необратимо.' },
  'tasks.deleteTask': { en: 'Delete Task', zh: '删除任务', ja: 'タスク削除', th: 'ลบงาน', mi: 'Mukua Mahi', ru: 'Удалить задачу' },
  'tasks.batchDelete': { en: 'Batch Delete', zh: '批量删除', ja: '一括削除', th: 'ลบเป็นชุด', mi: 'Mukua Rōpū', ru: 'Массовое удаление' },

  // ═══ Reports Panel ═══
  'reports.search': { en: '🔍 Search reports...', zh: '🔍 搜索报告...', ja: '🔍 レポート検索...', th: '🔍 ค้นหารายงาน...', mi: '🔍 Rapu pūrongo...', ru: '🔍 Поиск...' },
  'reports.draft': { en: '📝 Draft', zh: '📝 草稿', ja: '📝 下書き', th: '📝 ร่าง', mi: '📝 Tauira', ru: '📝 Черновик' },
  'reports.sent': { en: '📤 Sent', zh: '📤 已发送', ja: '📤 送信済み', th: '📤 ส่งแล้ว', mi: '📤 Kua Tukua', ru: '📤 Отправлено' },
  ...
  'reports.title': { en: 'Report title', zh: '报告标题', ja: 'レポートタイトル', th: 'ชื่อรายงาน', mi: 'Taitara Pūrongo', ru: 'Заголовок' },
  'reports.body': { en: 'Body (Markdown)', zh: '内容（Markdown）', ja: '本文（Markdown）', th: 'เนื้อหา (Markdown)', mi: 'Tinana (Markdown)', ru: 'Содержание (Markdown)' },
  'reports.deleteReport': { en: 'Delete Report', zh: '删除报告', ja: 'レポート削除', th: 'ลบรายงาน', mi: 'Mukua Pūrongo', ru: 'Удалить отчёт' },
  ...
  'settings.standup': { en: 'Daily Standup', zh: '每日站会', ja: 'デイリースタンドアップ', th: 'สแตนด์อัพรายวัน', mi: 'Tū Ata', ru: 'Ежедневный стендап' },
  ...
  'feedback.thankYou': { en: 'Thank you for your feedback!', zh: '感谢你的反馈！', ja: 'フィードバックありがとうございます！' },
  'feedback.sent': { en: 'Feedback sent. Thanks!', zh: '反馈已发送，感谢！', ja: '送信しました。' },
  'feedback.sentTo': { en: 'Opened in your browser — submit the GitHub Issue to send feedback. Thanks!', zh: '已在浏览器打开 — 提交 GitHub Issue 即可发送反馈，感谢！', ja: 'ブラウザで開きました — GitHub Issue を送信するとフィードバックが届きます。ありがとうございます！' },
  ...
  'feedback.bodyPlaceholder': { en: 'Expected vs actual behavior, reproduction steps, etc.', zh: '请描述预期行为、实际行为、复现步骤等', ja: '期待する動作・実際の動作・再現手順などを記入' },
  ...
  'feedback.footer': { en: 'Feedback is submitted via GitHub Issues', zh: '反馈通过 GitHub Issues 提交', ja: 'フィードバックは GitHub Issues で送信されます' },
  'feedback.sendFailed': { en: '❌ Submission failed, please try again.', zh: '❌ 提交失败，请重试。', ja: '❌ 送信に失敗しました。再試行してください。' },
  'feedback.noSmtp': { en: 'Please configure SMTP in Settings → Email before submitting feedback.', zh: '请先在 Settings → Email 配置 SMTP 后再提交反馈。', ja: 'Settings → Email でSMTPを設定してください。' },
  ...
  'emailTab.appPasswordHint': { en: 'App password or email password', zh: '应用专用密码或邮箱密码', ja: 'アプリパスワードまたはメールパスワード' },
  'emailTab.howToGetAuthCode': { en: 'How to get {provider} auth code', zh: '{provider} 授权码获取方法', ja: '{provider} 認証コードの取得方法' },
  ...
  'emailTab.smtpConnFailed': { en: '❌ SMTP connection failed', zh: '❌ SMTP 连接失败', ja: '❌ SMTP 接続に失敗しました' },
  ...
  'gitTab.workDirsDesc': { en: 'Add directories to scan for Git repos and commits. Auto-polled every 10 minutes.', zh: '添加目录以扫描 Git 仓库和提交记录。每 10 分钟自动轮询。', ja: 'Git リポジトリとコミットをスキャンするディレクトリを追加します。10分ごとに自動ポーリング。' },
  'gitTab.add': { en: '+ Add', zh: '+ 添加', ja: '+ 追加' },
  'gitTab.discoveredRepos': { en: 'Discovered Repos', zh: '发现的仓库', ja: '検出されたリポジトリ' },
  'gitTab.noReposFound': { en: 'No repos found yet. Add a work directory and scan.', zh: '尚未发现仓库。请添加工作目录并扫描。', ja: 'リポジトリが見つかりません。ワークディレクトリを追加してスキャンしてください。' },
  ...
  'gitTab.noCommits': { en: 'No commits recorded yet. Add a work directory and start scanning.', zh: '暂无提交记录。请添加工作目录并开始扫描。', ja: 'コミットが記録されていません。ワークディレクトリを追加してスキャンを開始してください。' },
  ...
  'gitTab.noReposFoundDialog': { en: 'No repos found.\nCheck:\n1) Work directory added\n2) Path is correct\n3) Git installed and in PATH', zh: '未发现仓库。请确认：\n1) 已添加工作目录\n2) 目录路径正确\n3) Git 已安装且在 PATH 中', ja: 'リポジトリが見つかりません。以下を確認：\n1) ワークディレクトリが追加されているか\n2) パスが正しいか\n3) Git がインストールされ PATH にあるか' },
  'gitTab.scanResult': { en: 'Found {repos} repos, {commits} new commits', zh: '发现 {repos} 个仓库，{commits} 条新提交', ja: '{repos} 件のリポジトリ、{commits} 件の新しいコミットを検出' },
  'gitTab.gitNotFound': { en: 'Git not found. Install Git and ensure it is in system PATH.', zh: '未找到 Git。请安装 Git 并确保其在系统 PATH 中。', ja: 'Gitが見つかりません。GitをインストールしてシステムPATHに追加してください。' },

  // ═══ Standup Settings Tab ═══
  'standupTab.morningCheckin': { en: 'Morning Check-in', zh: '晨会提醒', ja: '朝のチェックイン' },
  'standupTab.morningDesc': { en: "Show today's task summary at the top of chat at the set time.", zh: '到达设定时间后，在聊天窗口顶部显示今日任务摘要。', ja: '設定時間になると、チャット上部に今日のタスク概要を表示します。' },
  ...
  'standupTab.eveningDesc': { en: 'At the set time, auto-generate a daily report with a bubble notification.', zh: '到达设定时间后，自动汇总今日数据生成日报并气泡提醒。', ja: '設定時間になると、今日のデータを自動集計して日報を生成し、バブル通知します。' },
  'standupTab.enableEvening': { en: 'Enable auto evening report', zh: '启用晚报自动生成', ja: '夕方レポートを有効にする' },
  ...
  'emailForm.connFailed': { en: '❌ Connection failed. Check your host, port, email and password.', zh: '❌ 连接失败。请检查主机、端口、邮箱和密码。', ja: '❌ 接続に失敗しました。ホスト、ポート、メール、パスワードを確認してください。' },
  'emailForm.failed': { en: '❌ Failed', zh: '❌ 失败', ja: '❌ 失敗' },

  // ═══ Markdown Editor ═══
  'md.ctrlEnter': { en: 'Ctrl+Enter to exit code block', zh: 'Ctrl+Enter 退出代码块', ja: 'Ctrl+Enter でコードブロックを抜ける', th: 'Ctrl+Enter เพื่อออกจากบล็อกโค้ด', mi: 'Ctrl+Enter ki te puta i te paraka waehere', ru: 'Ctrl+Enter для выхода из блока кода' },

  // ═══ Update ═══
  'update.downloading': { en: 'Downloading', zh: '下载中', ja: 'ダウンロード中', th: 'กำลังดาวน์โหลด', mi: 'E tikiake ana', ru: 'Загрузка' },
  'update.downloaded': { en: 'Downloaded — restart to install', zh: '已下载，重启以安装', ja: 'ダウンロード完了 — 再起動してインストール', th: 'ดาวน์โหลดแล้ว — รีสตาร์ทเพื่อติดตั้ง', mi: 'Kua tikiake — whakaara anō hei tāuta', ru: 'Загружено — перезапустите' },

  // ═══ Evening Report ═══
  'evening.report': { en: '📋 Evening Report', zh: '📋 晚报', ja: '📋 イブニングレポート', th: '📋 รายงานเย็น', mi: '📋 Pūrongo Ahiahi', ru: '📋 Вечерний отчёт' },
  'evening.noData': { en: '⚠️ No data', zh: '⚠️ 暂无数据', ja: '⚠️ データなし', th: '⚠️ ไม่มีข้อมูล', mi: '⚠️ Kāore he raraunga', ru: '⚠️ Нет данных' },

  // ═══ Misc ═══
  'misc.error': { en: 'Error', zh: '错误', ja: 'エラー' },
  'misc.deleted': { en: 'Deleted', zh: '已删除', ja: '削除済み', th: 'ลบแล้ว', mi: 'Kua Mukua', ru: 'Удалено' },
  'misc.resolved': { en: 'Resolved', zh: '已处理', ja: '処理済み', th: 'จัดการแล้ว', mi: 'Kua Whakahaere', ru: 'Обработано' },
  'misc.cannotParse': { en: 'Cannot parse', zh: '无法解析', ja: '解析不能', th: 'แยกวิเคราะห์ไม่ได้', mi: 'Kāore e taea', ru: 'Не разобрать' },
  'misc.loading': { en: 'Loading...', zh: '加载中...', ja: '読み込み中...', th: 'กำลังโหลด...', mi: 'E uta ana...', ru: 'Загрузка...' },
  ...
  'emailList.noConfigDesc': { en: 'Connect your IMAP inbox and AI will automatically classify emails and draft smart replies.', zh: '配置 IMAP 邮箱后，AI 将自动分类收件箱并生成智能回复草稿。', ja: 'IMAP受信トレイを接続すると、AIが自動でメールを分類し、スマートな返信下書きを作成します。' },
  'emailList.goToSettings': { en: '⚙️ Go to Email Settings →', zh: '⚙️ 前往设置邮箱 →', ja: '⚙️ メール設定へ →' },
  'emailList.cat1Desc': { en: 'Urgent emails requiring immediate action — incidents, security issues, escalations', zh: '需要立即处理的紧急邮件，如生产事故、安全漏洞、老板加急等', ja: 'インシデント、セキュリティ問題など早急な対応が必要な緊急メール' },
  'emailList.cat2Desc': { en: 'Emails needing a reply today — task assignments, review requests, collaboration', zh: '需要在今天内回复的工作邮件，如任务指派、评审请求、协同讨论等', ja: 'タスク割り当て、レビュー依頼など今日中に返信が必要なメール' },
  'emailList.cat3Desc': { en: 'Notifications to be aware of — CI/CD alerts, system warnings, digests', zh: '只需知晓不需回复的通知类邮件，如 CI/CD 通告、系统告警、周报等', ja: 'CI/CD通知、システムアラートなど確認のみで返信不要の通知メール' },
  'emailList.cat4Desc': { en: 'Low-priority emails — newsletters, digests, marketing', zh: '不紧急的邮件，如订阅推送、技术简报、营销邮件等', ja: 'ニュースレターやマーケティングなど優先度の低いメール' },
  ...
  'emailPanel.unlinkMessage': { en: 'This will delete the linked task. Continue?', zh: '解除关联将删除此任务，确定继续？', ja: '関連付けを解除すると、このタスクは削除されます。続行しますか？' },
  ...
  'emailPanel.unsavedMessage': { en: 'Save draft before leaving?', zh: '保存草稿后退出？', ja: '下書きを保存してから退出しますか？' },
  ...
  'emailPanel.sendError.smtpIncomplete': { en: 'SMTP config incomplete', zh: 'SMTP 配置不完整', ja: 'SMTP設定が不完全です' },
  'emailPanel.sendError.noPassword': { en: 'SMTP password not configured', zh: '未配置 SMTP 密码', ja: 'SMTPパスワードが未設定です' },
  'emailPanel.sendError.noSmtpFound': { en: 'No SMTP config found', zh: '未找到 SMTP 配置', ja: 'SMTP設定が見つかりません' },
  ...
  'emailDetail.noConfig': { en: 'No email account connected.', zh: '未配置邮箱。', ja: 'メールアカウントが未設定です。' },
  ...
  'llmTab.contextWindow': { en: 'Context window: {n}K tokens (model limit, not editable)', zh: '上下文窗口: {n}K tokens（模型固定值，不可修改）', ja: 'コンテキストウィンドウ: {n}K トークン（モデル固定値、変更不可）' },
  'llmTab.maxOutputTokens': { en: 'Max Output Tokens', zh: '最大输出 Tokens', ja: '最大出力トークン' },
  'llmTab.maxTokensHint': { en: 'Lower values are ignored. The provider minimum is {floor}.', zh: '低于下限的值将被忽略，当前下限为 {floor}。', ja: '下限を下回る値は無視されます。現在の下限は {floor} です。' },
  'llmTab.apiKey': { en: 'API Key', zh: 'API Key', ja: 'APIキー' },
  'llmTab.apiKeyConfigured': { en: '✅ API key already configured. Enter a new key to replace.', zh: '✅ API Key 已配置，输入新 Key 替换。', ja: '✅ APIキー設定済み。新しいキーを入力すると置き換えます。' },
  ...
  'app.welcomeDesc': { en: 'Your AI office assistant. Chat, create, organize — all in one place.', zh: '你的 AI 个人办公助手。聊天、创建、整理——一站式搞定。', ja: 'あなたの生産性アシスタント。' },
  'app.welcomeGuide1': { en: '💬 Chat with AI — ask anything, create tasks, search notes', zh: '💬 在对话框与 AI 交流——创建任务、搜索笔记', ja: '💬 AIとチャット — 質問、タスク作成、ノート検索' },
  'app.welcomeGuide2': { en: '📋 Click bottom panel → Task/Note/Report', zh: '📋 点击下方面板 → 打开任务/笔记/报告', ja: '📋 下部の + をクリック → タスク/ノート/レポートパネルを開く' },
  'app.welcomeGuide3': { en: '📝 Say "create a task for..." to get started', zh: '📝 试试说"创建一个任务：重构登录模块"', ja: '📝 「認証モジュールのリファクタリングタスクを作成」と話しかけてみよう' },
  'app.sugg1': { en: 'Create a task: refactor auth module', zh: '创建一个任务：重构认证模块', ja: '進行中のタスクは？' },
  'app.sugg2': { en: 'Create a bug: login page broken', zh: '创建一个缺陷：登录页报错', ja: 'バグを作成' },
  'app.sugg3': { en: 'Write a note about API design', zh: '写一篇关于微服务架构的笔记', ja: 'Gitアクティビティ' },
  'app.sugg4': { en: 'Generate daily report', zh: '生成今日日报', ja: '日次レポート' },
  'app.sugg5': { en: 'Search notes', zh: '搜索笔记', ja: 'ノート検索' },
  ...
  'app.welcomeSetupGit': { en: 'Git Workspaces (Optional)', zh: 'Git 工作区（可选）', ja: 'Git ワークスペース（任意）' },
  ...
  'app.welcomeSetupLlmDesc': { en: '→ AI chat, smart task management, email replies', zh: '→ AI 聊天、智能任务管理、邮件智能回复', ja: 'AI チャット、タスク管理、メール返信' },
  'app.welcomeSetupLlmPriority': { en: '⚡ Configure first — affects email classification, report generation, and AI accuracy.', zh: '⚡ 建议优先配置 — 影响邮件分类、报告生成和 AI 准确性。', ja: '⚡ 最初に設定してください — メール分類、レポート生成、AIの精度に影響します。' },
  'app.welcomeSetupEmailDesc': { en: '→ AI inbox triage, smart reply drafts, email→task conversion', zh: '→ AI 收件箱分类、智能回复草稿、邮件转任务', ja: 'AI 受信トレイ分類、スマート返信' },
  'app.welcomeSetupGitDesc': { en: '→ Auto repo scanning, commit tracking, daily activity reports', zh: '→ 自动扫描仓库、提交跟踪、日报工作活跃度分析', ja: 'リポジトリ自動スキャン、コミット追跡' },
  'app.welcomeSetupApikey': { en: 'API Keys', zh: 'API Keys', ja: 'APIキー（任意）' },
  'app.welcomeSetupApikeyDesc': { en: '→ Create API tokens for external tools or MCP servers', zh: '→ 创建 API Token 供外部工具或 MCP Server 调用', ja: '→ APIトークンを作成、外部ツールやMCPサーバーからアクセス' },
  'app.welcomeSetupStandup': { en: 'Daily Standup', zh: '每日站会', ja: 'スタンドアップ（任意）' },
  'app.welcomeSetupStandupDesc': { en: '→ Morning task brief + evening report auto-generation', zh: '→ 早间任务简报 + 晚间日报自动生成', ja: '→ 朝タスク概要 + 夕方レポート自動作成' },
  'app.welcomeSetupMcp': { en: 'MCP Servers', zh: 'MCP 服务器', ja: 'MCPサーバー' },
  'app.welcomeSetupMcpDesc': { en: '→ Connect to Tomihub, GitHub, Jira etc. to extend AI capabilities', zh: '→ 连接 Tomihub、GitHub、Jira 等外部 MCP 服务器扩展 AI 能力', ja: '→ Tomihub、GitHub、JiraなどのMCPサーバーに接続してAIの機能を拡張' },
  ...
  'app.menuMcp': { en: 'MCP Approve', zh: 'MCP审批', ja: 'MCP 承認', th: 'ตรวจสอบ MCP', mi: 'Arotake MCP', ru: 'Аудит MCP' },
  'app.menuReports': { en: 'Reports', zh: '报告', ja: 'レポート', th: 'รายงาน', mi: 'Pūrongo', ru: 'Отчёты' },
  'app.menuFeedback': { en: 'Feedback', zh: '反馈', ja: 'フィードバック', th: 'ข้อเสนอแนะ', mi: 'Urupare', ru: 'Отзывы' },
