...
- **📝 Notes & Knowledge Base** — Markdown WYSIWYG editor (Milkdown), semantic search, multi-format export (Excel/Word/PDF/HTML/MD)
- **📊 Daily Reports** — morning task brief + evening wrap-up, auto-generated by AI, exportable (Excel/Word/PDF)
